...
@section('content')
    <div class="card-body">
        <div class="panel-heading mdl-color-text--red">Incentive</div>
        <a href="#" id="printDoc"
           class="btn btn-primary btn-labeled btn-labeled-left btn-lg legitRipple float-right mt-2 mr-2"><b><i
                    class="icon-printer2"></i></b> Print Incentive</a>
        ...
        {!! Form::open(['method'=>'POST','route'=>['incentive.uploadExcel'],'class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']) !!}
        <div class="row ">
            {!!Form::label('incentive','Upload Incentive Excel',['class'=>'col-form-label col-lg-2 require']) !!}

            <div class="form-group row col-lg-5 ">
                {{Form::file('incentive', ['class' =>' form-control','required'=>'required'])}}
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table id="incentive-table" class="table table-striped table-bordered mdl-data-table mt-2">
                        <thead>
                        <tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalTitle">Incentive</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            function search(page){
                ...
                $.ajax({
                    url: "incentive/search/?page="+page,
                    method: "get",
                    data: {
                        ta_id: ta_id,
                        from: from,
            ...
            function fetch_data(pageid) {
                $.ajax({
                    url: "incentive/fetch_data/?page=" + pageid,
                    method: "GET",
                    dataType: "json",
                    success: function (data) {
            ...
            $(document).on('click', '.delete', function () {
                ...
                if (confirm("Are you sure you want to delete this records?")) {
                    $.ajax({
                        url: "{{ route('incentive.delete_data') }}",
                        method: "POST",
        ...
        $('#incentive-table').on('click', 'a#openShow', function (e) {
            e.preventDefault();
            $('#showData').modal('show');
        ...
        $('#excelExport').on('click', function () {
            ...
            var url = "{{route('incentive.exportexcel')}}?" + $.param(query)
            window.location = url;
        });
