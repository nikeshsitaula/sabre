    ...
    <div class="card-body">
        <a href="#" id="printDoc"
           class="btn btn-primary btn-labeled btn-labeled-left btn-lg legitRipple float-right mt-2 mr-2"><b><i
                    class="icon-printer2"></i></b> Export Education</a>
        <div class="panel-heading mdl-color-text--red">Education</div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table id="education-table" class="table table-striped table-bordered mdl-data-table mt-2">
                        <thead>
                        <tr>
{{--                            <th>Emp No</th>--}}
                            <th>Qualification</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(pageid, emp_id) {
                ...
                $.ajax({
                    url: "education/fetch_data/?page=" + pageid,
                    method: "GET",
                    data: {
                        'emp_no': emp_id
                    },
                    ...
                    success: function (data) {
                        ...
                        for (var count = data.length - 1; count >= 0; count--) {
                            ...
                            html += '<td contenteditable class="column_name" data-column_name="qualification" data-id="' + data[count].id + '">' + data[count].qualification + '</td>';
                        ...
                        html += '<td contenteditable id="qualification"></td>';
            ...
            $(document).on('click', '#add', function () {
                ...
                var year = $('#year').text();
                if (emp_no != '' && qualification != '' && institute != '' && year != '') {
                    $.ajax({
            ...
            $(document).on('click', '.delete', function () {
                ...
                if (confirm("Are you sure you want to delete this records?")) {
                    $.ajax({
                        url: "{{ route('education.delete_data') }}",
                        method: "POST",
        ...
        $('#printDoc').on('click', function () {
            ...
            if(emp !==''){
                var id = $('.select2').val()
                $.ajax({
                    url: 'education/printEducation/' + id,
                    method: 'GET',
                    success: function (data) {
                        printPages(data);
                    }
