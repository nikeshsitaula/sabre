    ...
    <div class="card-body">
        <a href="#" id="printDoc"
           class="btn btn-primary btn-labeled btn-labeled-left btn-lg legitRipple float-right mt-2 mr-2"><b><i
                    class="icon-printer2"></i></b> Export Experience</a>
        <div class="panel-heading mdl-color-text--red">Experience</div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table id="experience-table" class="table table-striped table-bordered mdl-data-table mt-2">
                        <thead>
                        <tr>
{{--                            <th>Emp No</th>--}}
                            <th>Position</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(pageid, emp_id) {
                ...
                $.ajax({
                    url: "experience/fetch_data/?page=" + pageid,
                    method: "GET",
                    data: {
                        'emp_no': emp_id
                    },
                    ...
                    success: function (data) {
                        ...
                        for (var count = data.length - 1; count >= 0; count--) {
                            ...
                            html += '<td contenteditable class="column_name" data-column_name="organization" data-id="' + data[count].id + '">' + data[count].organization + '</td>';
            ...
            $(document).on('click', '#add', function () {
                ...
                if (emp_no != '' && position != '' && organization != '' && duration != '') {
                    $.ajax({
            ...
            $(document).on('click', '.delete', function () {
                ...
                if (confirm("Are you sure you want to delete this records?")) {
                    $.ajax({
                        url: "{{ route('experience.delete_data') }}",
                        method: "POST",
        ...
        $('#printDoc').on('click', function () {
            ...
            if(emp !==''){
                var id = $('.select2').val()
                $.ajax({
                    url: 'experience/printExperience/' + id,
                    method: 'GET',
                    success: function (data) {
                        printPages(data);
                    }
