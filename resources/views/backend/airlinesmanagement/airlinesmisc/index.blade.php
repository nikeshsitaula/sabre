...
@section('content')
    <div class="card-body">
        <div class="panel-heading mdl-color-text--red">Airlines Miscellaneous</div>
        <a href="#" id="printDoc"
           class="btn btn-primary btn-labeled btn-labeled-left btn-lg legitRipple float-right mt-2 mr-2"><b><i
                    class="icon-printer2"></i></b> Export Airlines Miscellaneous</a>
        <div class="row">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalTitle">Airline Miscellaneous</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(pageid, ai_id) {
                ...
                $.ajax({
                    url: "airlinesmisc/fetch_data/?page=" + pageid,
                    method: "GET",
                    data: {
                        'ai_id': ai_id
                    },
            ...
            $(document).on('click', '#add', function () {
                ...
                if (ai_id != '' && date != '' && particular != '' ) {
                    $.ajax({
                        url: "{{ route('airlinesmisc.store') }}",
                        method: "POST",
                        data: {
                            ai_id: ai_id,
                            date: date,
            ...
            $(document).on('click', '.delete', function () {
                ...
                if (confirm("Are you sure you want to delete this records?")) {
                    $.ajax({
                        url: "{{ route('airlinesmisc.delete_data') }}",
                        method: "POST",
        ...
        $('#printDoc').on('click', function () {
            ...
            if (emp !== '') {
                var id = $('.select2').val()
                $.ajax({
                    url: 'airlinesmisc/printairlinesmisc/' + id,
                    method: 'GET',
                    success: function (data) {
                        printPages(data);
                    }
