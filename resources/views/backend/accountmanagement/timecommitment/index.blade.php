...
@section('content')
    <div class="card-body">
        <div class="panel-heading mdl-color-text--red">Time Commitment</div>
        <a href="#" id="printDoc"
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table id="timecommitment-table" class="table table-striped table-bordered mdl-data-table mt-2">
                        <thead>
                        <tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalTitle">Time Commitment</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(pageid, ta_id) {
                $.ajax({
                    url: "timecommitment/fetch_data/?page=" + pageid,
                    method: "GET",
                    data: {
                        'ta_id': ta_id
                    },
            ...
            $(document).on('click', '#add', function () {
                ...
                if (ta_id != '' && from != '' && to != '' ) {
                    $.ajax({
                        url: "{{ route('timecommitment.store') }}",
                        method: "POST",
                        data: {
                            ta_id: ta_id,
                            from: from,
            ...
            $(document).on('blur', '.column_name', function () {
                ...
                if (column_value != '') {
                    $.ajax({
                        url: "{{ route('timecommitment.update') }}",
                        method: "POST",
            ...
            $(document).on('click', '.delete', function () {
                ...
                if (confirm("Are you sure you want to delete this records?")) {
                    $.ajax({
                        url: "{{ route('timecommitment.delete_data') }}",
                        method: "POST",
        ...
        $('#timecommitment-table').on('click', 'a#openShow', function (e) {
            e.preventDefault();
            $('#showData').modal('show');
        ...
        $('#printDoc').on('click', function () {
            ...
            if(emp !==''){
                var id = $('.select2').val()
                $.ajax({
                    url: 'timecommitment/printtimecommitment/' + id,
                    method: 'GET',
                    success: function (data) {
                        printPages(data);
                    }
